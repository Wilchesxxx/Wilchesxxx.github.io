import {login_auth, signInWithGoogle, signInWithFacebook, recoverPassword} from "../Controllers/global.js"
...
async function validar() {
    ...
    if (verificar != null) {
        ...
        if (email === "admin_wilches@gmail.com" && password === "Wilches123@") {
...
async function validarFacebook(){
    ...
    if(verificar != null){
        ...
        console.log("Sesion Facebook no es valida")
        alert("Error de usuario verifique usuario y/o contraseña")
    }
}
async function recuperar(){
    ...
    if (!email) {
        document.getElementById('error-message').textContent = 'llenar todos los campos';
        return;
    }
    try {
