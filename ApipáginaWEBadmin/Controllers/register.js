import { registerauth } from "../Controllers/global.js"
...
async function register() {
    if (window.verificado === true) {
        ...
        const validar = registerauth(emailInput, contraseñaInput, cedulaInput, fechaNacimientoInput, 
            direccionInput, telefonoInput, nombreInput, apellidoInput); 
